...
let backgroundArray = [
  {
    ...
    url1: "url('../img/zsuzsa.jpg')",
    url2: "url('../img/zsuzsa.jpg')",
  ...
  {
    url1: "url('../img/toma.jpg')",
    url2: "url('../img/tomb.jpg')",
  ...
  {
    url1: "url('../img/eva.jpg')",
    url2: "url('../img/eva.jpg')",
  ...
  {
    url1: "url('../img/hajnia.jpg')",
    url2: "url('../img/hajnib.jpg')",
  ...
  {
    url1: "url('../img/rikia.jpg')",
    url2: "url('../img/rikib.jpg')",
    text: "Among the most dramatic evidence that Eath's climate is warming is the dwindling and disappearance of mountain glaciers around the world. Based on scientific data, 2018 was the 30th year in a row of mass loss of mountain glaciers worldwide. Muir Glacier in southern Alaska (in the photo) retreated more than 30 miles between the 1890s and 2005."
  }
